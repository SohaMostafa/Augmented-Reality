...
/**
 * Static methods for dealing with {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItem}s.
 */
public class ColorItems {
    /**
     * A key for saving the {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItem}s of the user.
     */
    ...
    /**
     * A {@link java.lang.reflect.Type} instance of a {@link java.util.List} of {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItem}s.
     */
    ...
    /**
     * A {@link java.util.Comparator} for sorting {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItem}s in chronological order of creation.
     */
...
/**
        * Get the {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItem}s of the user.
            *
            * @param context a {@link android.content.Context}.
            * @return a {@link java.util.List} of {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItem}s.
     */
     ...
     * Get the {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItem}s of the user.
     *
     * @param sharedPreferences a {@link android.content.SharedPreferences} from which the {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItem}s will be retrieved.
     * @return a {@link java.util.List} of {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItem}s.
     */
    ...
    /**
     * Save a {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItem}s.
     *
     * @param context     a {@link android.content.Context}.
     * @param colorToSave the {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItem} to save.
     * @return Returns true if the new {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItem} was successfully written to persistent storage.
     */
    ...
    /**
     * Register a {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItems.OnColorItemChangeListener}.
     * <p/>
     ...
     *
     * @param context                   a {@link android.content.Context}.
     * @param onColorItemChangeListener the {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItems.OnColorItemChangeListener} to register.
     */
    ...
    /**
     * Unregister a {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItems.OnColorItemChangeListener}.
     *
     * @param context                   a {@link android.content.Context}.
     * @param onColorItemChangeListener the {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItems.OnColorItemChangeListener} to unregister.
     */
    ...
    /**
     * A simple class for listening to the changes of the {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItem}s of the user.
     */
    public abstract static class OnColorItemChangeListener implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        /**
         * Called when the {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItem}s of the user have just changed.
         *
         * @param colorItems the current {@link java.util.List} of the {@link com.google.android.gms.samples.vision.ocrreader.data.ColorItem}s of the user.
         */
